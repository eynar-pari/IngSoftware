...
public class Main {
	...
	public static void create(int id, String name, int age) {
        ...
        System.out.println("Creating student : " + name+ " id : "+id);
	...
	public static void delete(int id) {
		// Create an EntityManager
        System.out.println("Creating Removing Student with id : "+id);
		EntityManager manager = ENTITY_MANAGER_FACTORY.createEntityManager();
		EntityTransaction transaction = null;
	...
	public static void upate(int id, String name, int age) {
		// Create an EntityManager
        System.out.println("Updating student : "+name+ "with id : "+id);
		EntityManager manager = ENTITY_MANAGER_FACTORY.createEntityManager();
		EntityTransaction transaction = null;
